...
We are proud to announce the availability of __Monkey v1.6.6__, below a list of changes:

### Changes

Below there is a list of the most relevant changes on this version:

- HTTP: remove connection from timeout queue before processing
- Scheduler: fix MK_TRACE msg socket number
- Debian: add missing init script
